...
--部门表
insert into dept values(dept_dno_Seq.Nextval,'软件工程','佚名1','18804539085','软件学院');
insert into dept values(dept_dno_Seq.Nextval,'信息安全','佚名2','13982736473','软件学院');
insert into dept values(dept_dno_Seq.Nextval,'研究生院办','佚名3','17768237238','软件学院');
insert into dept values(dept_dno_Seq.Nextval,'学工办','佚名4','15180457236','软件学院');
...
--教师表
insert into teacher values(teacher_tno_Seq.nextval,'贾晓娟','女',to_date('1987-01','YYYY-MM'),'4','教师1电话','讲师','0001','0','教师1卡号');
insert into teacher values(teacher_tno_Seq.nextval,'钟红','女',to_date('1987-02','YYYY-MM'),'4','教师2电话','副教授','0002','0','教师2卡号');
insert into teacher values(teacher_tno_Seq.nextval,'刘雪恩','女',to_date('1987-03','YYYY-MM'),'4','教师3电话','教授','0003','0','教师3卡号');
insert into teacher values(teacher_tno_Seq.nextval,'刘晓芒','女',to_date('1967-04','YYYY-MM'),'4','教师4电话','教授','0004','1','教师4卡号');
insert into teacher values(teacher_tno_Seq.nextval,'王媛媛','女',to_date('1987-05','YYYY-MM'),'4','教师5电话','助教','0005','0','教师5卡号');
insert into teacher values(teacher_tno_Seq.nextval,'孙荣','男',to_date('1987-06','YYYY-MM'),'4','教师6电话','高工','0006','0','教师6卡号');
